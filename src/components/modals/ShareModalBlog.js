...
class ShareModal extends Component {
    ...
    render() {
      ...
      const url = `https://intexchange.org/${uri}`
      ...
      return (
        <div>
            <BrowserView>
            <a href="#share" onClick={this.openModal}
                  sx={{
                    position: 'relative',
                    display: 'flex',
                    flexDirection: 'row',
                ...
                <span
                    sx={{
                        display: 'flex',
                        marginRight: ['0.4166vw', '10px', '10px', '0.4166vw'],
                        width: ['0.8854vw', '17px', '17px', '0.8854vw']
                    }}
                >
                ...
                <FormattedMessage id="buttonshare" />
            </a>
            </BrowserView>
            <MobileView>
            <a href="#share" onClick={shareHandler}
                  sx={{
                    position: 'relative',
                    display: 'flex',
                    flexDirection: 'row',
          ...
          >           
            ...
            >
                ...
                >  
                    <Styled.h2 sx={{color: 'black', marginBottom: '2vh'}}><FormattedMessage id="buttonshare" /></Styled.h2>
                    <div
                        sx={{
                            display: 'block',

...
import SeoContentText from "../components/molecules/SeoContentText"
...
const IndexPage = ({ location }) => {
    ...
    const data = useStaticQuery(graphql`{
        wordpress {
            forChildrens(where: {language: DEFAULT, orderby: {field: MENU_ORDER, order: ASC}}) {
              nodes {
                title
                uri
                id
                  ...
                  >
                    ...
                    >
                      ...
                      {data.wordpress.forChildrens.nodes.map(node => (
                        ...
                        <div key={node.id}><ContentList {...node} /></div>

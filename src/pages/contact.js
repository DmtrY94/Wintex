                    ...
                    >                      
                        ...
                        >                        
                          ...
                          >
                            ...
                            >
                              <a href={`tel:${data.wordpress.pageBy.PageContacts.phonek1}`}
                                sx={{                        
                                  textTransform: 'uppercase',
                                  fontWeight: '500',
                              ...
                              href={`tel:${data.wordpress.pageBy.PageContacts.phonek2}`}>{data.wordpress.pageBy.PageContacts.phonek2}</a>
                            </div>
                          </div>
                          <div
                            sx={{
                          ...
                          >
                            ...
                            >
                              <a href={`tel:${data.wordpress.pageBy.PageContacts.phonekr1}`}
                                sx={{                        
                                  textTransform: 'uppercase',
                                  fontWeight: '500',
                                  fontSize: ['calc(4.5*0.25vw)', '1.5rem', 'calc(6.7*0.25vw)', 'calc(5.7*0.25vw)', 'calc(4.5*0.25vw)'],
                              ...
                              href={`tel:${data.wordpress.pageBy.PageContacts.phonekr2}`}>{data.wordpress.pageBy.PageContacts.phonekr2}</a>
                            </div>
                          </div>
                          <div
                              sx={{
